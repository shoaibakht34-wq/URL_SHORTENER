  ...
  return (
    <div className="h-16 bg-custom-gradient  z-50 flex items-center sticky top-0 ">
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
        ...
        <ul
  className={`flex sm:gap-10 gap-4 sm:items-center sm:mt-1 sm:pt-0 pt-3 text-slate-800 sm:static absolute left-0 top-16 sm:shadow-none shadow-md ${
    navbarOpen ? "h-fit sm:pb-0 pb-5" : "h-0 overflow-hidden"
  } transition-all duration-100 sm:h-fit sm:bg-transparent bg-transparent sm:w-fit w-full sm:flex-row flex-col px-4 sm:px-0`}
>
